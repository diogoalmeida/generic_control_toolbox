...
class MarkerManager : public ManagerBase
{
 public:
  ...
  /**
    Initializes a new marker group, including a new realtime publisher for the
  group.

    @param group_key The new marker group key.
    @param topic_name The topic name under which the marker group will be
  published.
    @return False if something goes wrong, true otherwise.
  **/
  bool addMarkerGroup(const std::string &group_key,
  ...
  **/
  bool addMarker(const std::string &group_key, const std::string &marker_name,
  ...
  **/
  bool setMarkerColor(const std::string &group_key,
                      const std::string &marker_name, double r, double g,
                      double b);
  ...
  /**
    ...
    @return false if marker_name is not found.
  **/
  bool setMarkerScale(const std::string &group_key,
                      const std::string &marker_name, double x, double y,
                      double z);
  ...
  /**
    ...
    @return False if marker_name is not found or if marker type does not allow
  to set points.
  **/
  bool setMarkerPoints(const std::string &group_key,
  ...
  to set pose.
  **/
  bool setMarkerPose(const std::string &group_key,
                     const std::string &marker_name,
  ...
  **/
  bool getMarkerId(const std::string &group_key, const std::string &marker_name,
                   int &id) const;
};
}  // namespace generic_control_toolbox
#endif
